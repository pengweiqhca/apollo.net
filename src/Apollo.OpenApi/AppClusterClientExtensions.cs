...
public static class AppClusterClientExtensions
{
    ...
    public static Task<IReadOnlyList<EnvCluster>?> GetEnvClusterInfo(this IAppClusterClient client,
        ...
        client.ThrowIfNull().Get<IReadOnlyList<EnvCluster>>($"apps/{client.AppId}/envclusters", cancellationToken);
    ...
    {
        var list = await client.ThrowIfNull().Get<IReadOnlyList<AppInfo>>("apps?appIds=" + WebUtility.UrlEncode(client.AppId), cancellationToken).ConfigureAwait(false);
    ...
    public static Task<IReadOnlyList<AppInfo>?> GetAppsInfo(this IAppClusterClient client,
        ...
        appIds == null || appIds.Count == 0
            ? client.ThrowIfNull().Get<IReadOnlyList<AppInfo>>("apps", cancellationToken)
            : client.ThrowIfNull().Get<IReadOnlyList<AppInfo>>($"apps?appIds={WebUtility.UrlEncode(string.Join(",", appIds))}", cancellationToken);
    ...
    public static Task<Cluster?> GetCluster(this IAppClusterClient client, string env,
        ...
        CancellationToken cancellationToken = default) =>
        client.ThrowIfNull().Get<Cluster>($"envs/{env.ThrowIfNull()}/apps/{client.AppId}/clusters/{clusterName}", cancellationToken);
    ...
    public static Task CreateCluster(this IAppClusterClient client, string env,
        ...
        client.ThrowIfNull().Post<Cluster>($"envs/{env.ThrowIfNull()}/apps/{client.AppId}/clusters", cluster, cancellationToken);
    ...
    public static Task<IReadOnlyList<Namespace>?> GetNamespaces(this IAppClusterClient client, string env,
        string clusterName = ConfigConsts.ClusterNameDefault, CancellationToken cancellationToken = default) =>
        client.ThrowIfNull().Get<IReadOnlyList<Namespace>>($"envs/{env.ThrowIfNull()}/apps/{client.AppId}/clusters/{clusterName}/namespaces", cancellationToken);
    ...
    public static Task<AppNamespace?> CreateAppNamespace(this IAppClusterClient client,
        ...
        client.ThrowIfNull().Post<AppNamespace>($"apps/{client.AppId}/appnamespaces", appNamespace.ThrowIfNull(), cancellationToken);
}
